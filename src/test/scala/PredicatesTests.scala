...
//import sygus.{ExamplePredicate, ExpressionParser, Predicates, PythonPBETask, RetainPredicate, UsesVariablesPredicate}
//
...
//    val retain_predicate = RetainPredicate(tree, 0)
...
//    val parser = new ExpressionParser(predicates)
//    val tree = parser.parse("x.upper()")
//    val retain_predicate = RetainPredicate(tree, 1)
...
//    assertEquals(retain_predicate.observe(program),Some(1))
//  }
...
//    val new_predicates = Predicates(List(examples_list.head, retain_predicate, UsesVariablesPredicate(1)), 1)
//    val program = PyStringUpper(PyStringVariable("x", new_predicates), new_predicates)
//    assertEquals(retain_predicate.observe(program),Some(3))
//  }
//
...
//    assertEquals(retain_predicate.observe(program), Some(0))
//  }
//
...
//// }
////  @Test def check_retain_list: Unit = {
////    val task = PythonPBETask.fromString(
////      """{
////        |  "varName": "rs",
////        |  "env": [
