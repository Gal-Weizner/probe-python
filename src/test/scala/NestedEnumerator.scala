...
class NestedEnumerator extends JUnitSuite {
  ...
  @Test def enumerateVocabNoOE: Unit = {
    ...
    val literal: PyIntLiteral = new PyIntLiteral(42, 2, predicates1)
      assertEquals(literal.values, List(42))
    ...
    assertEquals(enumerator.next().code,"s[::-1]")
    assertEquals(enumerator.next().code,"s[::3]")
    assertEquals(enumerator.next().code,"\" \".find(s)")
    assertEquals(enumerator.next().code,"s.find(s)")
    assertEquals(enumerator.next().code,"s.count(s)")
    ...
    assertEquals(enumerator.next().code,"s.split(s)")
    ...
    assertEquals(enumerator.next().code,"3 * 3")
    assertEquals(enumerator.next().code,"-1 - 3")
    assertEquals(enumerator.next().code, "{var: var for var in \" \"}")
    ...
    assertEquals(enumerator.next().code,"str(s.find(s))")
    assertEquals(enumerator.next().code,"str(s.count(s))")
    assertEquals(enumerator.next().code,"str(len(str(-1)))")
    assertEquals(enumerator.next().code,"str(1 + 3)")
    assertEquals(enumerator.next().code,"str(-1 + -1)")
    assertEquals(enumerator.next().code,"str(3 + 3)")
    assertEquals(enumerator.next().code,"str(-1 * 3)")
    assertEquals(enumerator.next().code,"str(3 * 3)")
    assertEquals(enumerator.next().code,"str(-1 - 3)")
